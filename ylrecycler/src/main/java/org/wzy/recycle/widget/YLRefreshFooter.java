...
import org.wzy.recycle.progressindicator.AVLoadingIndicatorView;
import org.wzy.recycle.progressindicator.ProgressStyle;
import org.wzy.recycle.progressindicator.SimpleViewSwitcher;
...
public class YLRefreshFooter extends LinearLayout {
     ...
     * @param attrs
     */
    public YLRefreshFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
